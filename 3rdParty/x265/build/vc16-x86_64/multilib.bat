...
@cd 12bit
cmake -G "Visual Studio 16 2019" -A x64 -DSTATIC_LINK_CRT=ON ../../../source -DHIGH_BIT_DEPTH=ON -DEXPORT_C_API=OFF -DENABLE_SHARED=OFF -DENABLE_CLI=OFF -DMAIN12=ON
if exist x265.sln (
...
@cd ..\10bit
cmake -G "Visual Studio 16 2019" -A x64 -DSTATIC_LINK_CRT=ON ../../../source -DHIGH_BIT_DEPTH=ON -DEXPORT_C_API=OFF -DENABLE_SHARED=OFF -DENABLE_CLI=OFF
if exist x265.sln (
  MSBuild /property:Configuration="Release" x265.sln
...
cmake -G "Visual Studio 16 2019" -A x64 -DSTATIC_LINK_CRT=ON ../../../source -DEXTRA_LIB="x265-static-main10.lib;x265-static-main12.lib" -DLINKED_10BIT=ON -DLINKED_12BIT=ON
if exist x265.sln (
  MSBuild /property:Configuration="Release" x265.sln
